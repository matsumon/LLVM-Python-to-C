...
@test "LLVM IR representing correct computation generated for while_1" {
	filename=while_1
...
@test "LLVM IR representing correct computation generated for while_2" {
	filename=while_2
	pyfile="${PYTHON_DIR}/${filename}.py"
	return_value_file="${RETURN_VALUE_DIR}/${filename}"
	llfile="${BATS_TMPDIR}/${filename}.ll"
...
@test "LLVM IR representing correct computation generated for while_3" {
	filename=while_3
	pyfile="${PYTHON_DIR}/${filename}.py"
	return_value_file="${RETURN_VALUE_DIR}/${filename}"
	llfile="${BATS_TMPDIR}/${filename}.ll"
...
@test "LLVM IR representing correct computation generated for while_4" {
	filename=while_4
	pyfile="${PYTHON_DIR}/${filename}.py"
	return_value_file="${RETURN_VALUE_DIR}/${filename}"
	llfile="${BATS_TMPDIR}/${filename}.ll"
