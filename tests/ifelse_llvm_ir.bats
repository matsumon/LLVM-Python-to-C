...
@test "LLVM IR representing correct computation generated for ifelse_1" {
	filename=ifelse_1
...
@test "LLVM IR representing correct computation generated for ifelse_2" {
	filename=ifelse_2
	pyfile="${PYTHON_DIR}/${filename}.py"
	return_value_file="${RETURN_VALUE_DIR}/${filename}"
	llfile="${BATS_TMPDIR}/${filename}.ll"
...
@test "LLVM IR representing correct computation generated for ifelse_3" {
	filename=ifelse_3
	pyfile="${PYTHON_DIR}/${filename}.py"
	return_value_file="${RETURN_VALUE_DIR}/${filename}"
	llfile="${BATS_TMPDIR}/${filename}.ll"
...
@test "LLVM IR representing correct computation generated for ifelse_4" {
	filename=ifelse_4
	pyfile="${PYTHON_DIR}/${filename}.py"
	return_value_file="${RETURN_VALUE_DIR}/${filename}"
	llfile="${BATS_TMPDIR}/${filename}.ll"
...
@test "LLVM IR representing correct computation generated for ifelse_5" {
	filename=ifelse_5
	pyfile="${PYTHON_DIR}/${filename}.py"
	return_value_file="${RETURN_VALUE_DIR}/${filename}"
	llfile="${BATS_TMPDIR}/${filename}.ll"
